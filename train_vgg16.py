...
from models import build_vgg16_model
...
def main():
    ...
    model, base_model = build_vgg16_model(num_classes=len(CLASS_NAMES))
    ...
    print("\nFinal model saved to models/vgg16_final.h5")
